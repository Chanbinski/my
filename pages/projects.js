    ...
    return (
        <div>
            ...
            <div className="mt-20 flex flex-col justify-center items-center">
                ...
                <div className="mt-10 grid sm:grid-cols-2 gap-6 w-1/2">
                    <div className="bg-blue-50 border border-blue-50 p-4 rounded-lg gap-y-4">
                    ...
                    <div className="bg-indigo-50 border border-indigo-50 p-4 rounded-lg gap-y-4">
